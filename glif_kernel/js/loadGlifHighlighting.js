...
function loadGlifHighlighting(CodeMirror) {
    ...
    CodeMirror.defineAdvancedMode("GLIF", {
		"start": [
				...
				{regex: /(type|kind|accumulate)/um, token: "keyword", transition: "elpi.root"},
				{regex: /(archive|construct|e(?:g|lpigen)|filter|g(?:enerate_(?:random|trees)|[rt])|import|linearize|p(?:arse|ut_(?:string|tree)|[st])|status|v(?:isualize_(?:(?:pars|tre)e)|[pt])|[acilp])$/um, token: "keyword", transition: "cmd.root"},
				{regex: /(archive|construct|e(?:g|lpigen)|filter|g(?:enerate_(?:random|trees)|[rt])|import|linearize|p(?:arse|ut_(?:string|tree)|[st])|status|v(?:isualize_(?:(?:pars|tre)e)|[pt])|[acilp])\b/um, token: "keyword", transition: "cmd.incommand"},
		...
		"elpi.root": [
				...
				{regex: /(\s+)/um, token: "whitespace"},
				{regex: /(type|kind|accumulate)/um, token: "keyword"},
