...
function loadGlifHighlighting(CodeMirror) {
    ...
    CodeMirror.defineAdvancedMode("GLIF", {
		"start": [
				...
				{regex: /(archive|construct|e(?:g|lpigen)|filter|import|linearize|p(?:arse|s|ut_string)|v(?:isualize_tree|t)|[acilp])$/um, token: "keyword", transition: "cmd.root"},
				{regex: /(archive|construct|e(?:g|lpigen)|filter|import|linearize|p(?:arse|s|ut_string)|v(?:isualize_tree|t)|[acilp])\b/um, token: "keyword", transition: "cmd.incommand"},
