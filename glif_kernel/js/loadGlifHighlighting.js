...
function loadGlifHighlighting(CodeMirror) {
    ...
    CodeMirror.defineAdvancedMode("GLIF", {
		"start": [
				...
				{regex: /(elpi:|ELPI:)(\s+)(\w+)/um, token: ["header", "whitespace", "variable"], transition: "elpi.root"},
				...
				{regex: /(archive|construct|import|linearize|p(?:arse|s|ut_string)|[acilp])\b/um, token: "keyword", transition: "cmd.incommand"},
