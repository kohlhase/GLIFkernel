...
import { LRLanguage, indentNodeProp, continuedIndent, delimitedIndent, LanguageSupport } from '@codemirror/language';
...
// GLIF SCRIPT
const GLIFScriptLanguage = LRLanguage.define({
...
// GF
const GFLanguage = LRLanguage.define({
    parser: parser$2.configure({
        props: [
            indentNodeProp.add({
                Section: continuedIndent(),
            ...
            styleTags({
                ...
                GrammarModifier: tags.keyword,
                GrammarType: tags.keyword,
                GrammarName: tags.className,
                Pragma: tags.special(tags.lineComment),
...
// MMT
const MMTLanguage = LRLanguage.define({
    parser: parser$1.configure({
        props: [
            ...
            styleTags({
                KeyWord: tags.keyword,
                ModuleComment: tags.blockComment,
                DeclarationComment: tags.blockComment,
                ModuleName: tags.definition(tags.className),
                NotationObject: tags.regexp,
                TypeObject: tags.typeName,
                ModuleRef: tags.name,
                OD: tags.punctuation,
                DD: tags.punctuation,
                MD: tags.punctuation,
...
// ELPI
const ELPILanguage = LRLanguage.define({
    parser: parser.configure({
        props: [
            ...
            styleTags({
                ...
                String: tags.string,
                Int: tags.integer,
                TypingPred: tags.keyword,
                ModulePred: tags.keyword,
                Variable: tags.propertyName,
                Discard_variable: tags.propertyName,
            })
        ],
        specializers: [{
...
// GLIF CELL
const GLIFCellLanguage = LRLanguage.define({
    parser: parser$3.configure({
        props: [
            styleTags({
                ElpiHeader: tags.documentMeta,
                MmtHeader: tags.documentMeta,
                ScriptHeader: tags.documentMeta,
                GfHeader: tags.documentMeta,
                LineComment: tags.lineComment,
                BlockComment: tags.blockComment,
            })
        ],
...
export { ELPI, ELPILanguage, GF, GFLanguage, GLIFCell, GLIFCellLanguage, GLIFScript, GLIFScriptLanguage, MMT, MMTLanguage };
